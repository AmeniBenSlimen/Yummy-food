          ...
          <li><a href="#gallery">Galerie</a></li>
                    ...
                    <ul class="btn-book-a-table">
                        ...
                        @guest
                            ...
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link" style="color:white" href="{{ route('register') }}">{{ __('Crée un Compte') }}</a>
                                </li>
                            @endif
                        @else
                            <li class="nav-item dropdown">
                               ...
                               <div class="dropdown-menu dropdown-menu-end" style="width:400px;" aria-labelledby="navbarDropdown">
                                Bonjour,  {{ Auth::user()->name }}
                                
                                <hr>
                                
                                    <a class="dropdown-item" href="{{ route('GetFormProduct') }}"
                                      >
                                ...
                                <a class="dropdown-item" href="{{ route('ListeProduit') }}"
                                  >
                                    {{ __('Consulter Liste des Produits') }}
                                </a> 
                                <hr>
